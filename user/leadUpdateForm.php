...
if (isset($_GET['leadid'])){
    ...
    include '../allList.php';
    $obj = new newList();
    $var="SELECT * FROM leadinfo_tb  WHERE leadId = :id";
    $par=':id';
    $row = $obj->sqlFun($var,$par,$lId);
//getting contact information
    $var="SELECT * FROM contactinfo_tb  WHERE leadId = :id";
    $par=':id';
    $cont = $obj->Fun($var,$par,$lId);
?>
            <!-- ============================================================== -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Lead Update Form</h4>
                                    <div class="clearfix">
                            ...
                            <div class="row m-t-20">
                                <div class="col-sm-12">
                                    <form id="default-wizard" action="../adminControl.php" method="POST">
                                        <fieldset >
                                            <input type="hidden" name="ldID" value="<?php echo $row["leadId"]; ?>">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="tags-default">
                                                            <input type="text"  class="form-control" data-role="tagsinput" placeholder="add tags" value="<?php echo $row["tag"]; ?>" name="tag">
                                                        </div>
                                                    </div>
...
?>
                                        ...
                                        <div class="row m-t-20">
                                            ...
                                            <div class="col-sm-1">
                                               <button type="submit" class="btn btn-success stepy-finish" name="leadInofUpdate">Update</button> 
                                            </div>
                                            <div class="col-sm-1">                    
                                                <a href="leads.php" class="btn btn-danger stepy-finish" name="btn">Close</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
