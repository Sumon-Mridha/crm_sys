...
include 'userHeader.php';
    include '../allList.php';
    $obj = new newList();
    $row = $obj->allSql("SELECT cmpName,productName,cpId,cpdatetime FROM customerinfo_tb c RIGHT JOIN (SELECT productName,cpId,customerId,cpdatetime FROM product_tb p INNER JOIN customerproduct_tb cp ON p.productId = cp.productId) s ON c.customId = s.customerId");
    $cnt=0;
    // var_dump($row);
