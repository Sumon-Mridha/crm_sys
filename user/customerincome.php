...
include '../allList.php';
$obj=new newList();
$sql= "SELECT pn.cmpName,ps.* FROM customerinfo_tb pn INNER JOIN (SELECT customerId, SUM(cost) total,COUNT(productId) numberofsales FROM customerproduct_tb GROUP BY customerId) ps ON pn.customId = ps.customerId ";
$tkt1 = $obj->allSql($sql);
// $row=$obj->all("");
?>
            <!-- ============================================================== -->
